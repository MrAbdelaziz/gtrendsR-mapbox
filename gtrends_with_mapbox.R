...
getGoogleTrendData <- function(keyword,start ="2022-07-26",end = "2022-07-29") {
...
data <- getGoogleTrendData("Keyword_Here")
...
change the token and remove me :)
mapbox_token <- "_Token_here" 
